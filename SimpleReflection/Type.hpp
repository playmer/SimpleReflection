...
#include "SimpleReflection/OrderedMultiMap.hpp"
#include "SimpleReflection/OrderedMap.hpp"
...
namespace srefl
{
  ...
  // Requires sreflDefineType be used at some point in a
  // translation unit.
#define sreflDeclareType(Name)                                          \
void Dummy() {}                                                       \
typedef decltype(::srefl::GetDummy(&Name::Dummy)) TempSelfType;         \
typedef decltype(::srefl::GetSelfType<TempSelfType>(nullptr)) BaseType; \
typedef TempSelfType SelfType;                                        \
static ::srefl::Type sType;                                  \
static ::srefl::Type* GetStaticType() { return &sType; };    \
::srefl::Type* GetType() { return &sType; };                 \
static void InitializeType();


#define sreflDefineType(Name)                              \
::srefl::Type Name::sType{#Name,                           \
...
void Name::InitializeType()
  ...
  {
  public:
    sreflDeclareType(DocumentedObject);
  ...
  struct TypeIdentification<tType*>
  {
    static inline Type* TypeId()
    {
      ...
      static Type type{ ::srefl::TypeId<tType>(), 
...
#define sreflDefineExternalType(Name)                                   \
namespace srefl                                                         \
{                                                                     \
  Type TypeIdentification<Name>::cType{ #Name,                        \
                                        static_cast<Name*>(nullptr)}; \
}                                                                     \
template<> void srefl::InitializeType<Name>()

sreflDeclareExternalType(void)
sreflDeclareExternalType(bool)
sreflDeclareExternalType(srefl::s8)
sreflDeclareExternalType(srefl::i8)
sreflDeclareExternalType(srefl::i16)
sreflDeclareExternalType(srefl::i32)
sreflDeclareExternalType(srefl::i64)
sreflDeclareExternalType(srefl::u8)
sreflDeclareExternalType(srefl::u16)
sreflDeclareExternalType(srefl::u32)
sreflDeclareExternalType(srefl::u64)
sreflDeclareExternalType(float)
sreflDeclareExternalType(double)
sreflDeclareExternalType(std::string)
